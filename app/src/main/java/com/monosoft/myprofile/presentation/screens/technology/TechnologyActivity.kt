...
class TechnologyActivity : AppCompatActivity() {
    ...
    lateinit var bindin : ActivityTechnologyBinding
    var text1 =  ""
    var text2 =  ""
    var text3=   ""
    var text4 =  ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindin = ActivityTechnologyBinding.inflate(layoutInflater)
        ...
        Glide.with(this@TechnologyActivity).load(image).into(bindin.imageTech)
        setUp()
        ...
        bindin.lblVerT.setOnClickListener {
            ...
            when(technology.uppercase()){
                ...
                Technology.GOOGLEMAPS.type->{
                    ...
                    val intent = Intent(this@TechnologyActivity,MapsActivity::class.java)
